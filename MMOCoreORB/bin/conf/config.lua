...
InactiveAccountText = "Your account has either not been activated for the first time, or has been disabled by an admin."
...
LumberjackVendor = 1
LumberjackDeleted = 1
LubmberjackRareLoot = 1
LumberjackTXT = 1
LumberjackSQL = 0

AdminOwnerNames = "Opi Jumeul Emirita"
