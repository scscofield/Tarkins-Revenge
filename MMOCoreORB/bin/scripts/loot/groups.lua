...
includeFile("groups/tarkin_custom/holocron_splinters.lua")
...
includeFile("groups/tarkin_custom/hutt_hideout.lua")
includeFile("groups/tarkin_custom/pirate_bunker.lua")
