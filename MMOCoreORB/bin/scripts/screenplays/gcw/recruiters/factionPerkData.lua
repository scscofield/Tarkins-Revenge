...
rebelRewardData = {
	...
	weaponsArmor = {
		...
		armor_marine_chest_plate = { index=4, type=factionRewardType.armor, display="@craft_armor_ingredients_n:armor_marine_chest_plate_rebel", item="object/tangible/loot/loot_schematic/rebel_marine_chest_plate_schematic.iff",cost=4000},
		...
		rocket_launcher = { index=13, type=factionRewardType.weapon, display="@weapon_name:rocket_launcher", item="object/weapon/ranged/heavy/heavy_rocket_launcher.iff", cost=5000},
		lance_staff_metal = { index=14, type=factionRewardType.weapon, display="@weapon_name:lance_staff_metal", item="object/weapon/melee/polearm/lance_staff_metal.iff", cost=1000},
