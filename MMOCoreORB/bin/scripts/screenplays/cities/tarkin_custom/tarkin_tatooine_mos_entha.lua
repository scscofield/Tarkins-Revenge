...
--	spawnMobile(self.planet, "eg6_power_droid",60,1332.45,7.90682,3237.09,8.18614,0)
	spawnMobile(self.planet, "informant_npc_lvl_1",0,1263.59,7,3137.32,30,0)
...
--	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "scientist",60,1311.1,7,3081.03,0,0)
--	self:setMoodString(pNpc, "conversation")
...
--	self:setMoodString(pNpc, "conversation")
	...
	spawnMobile(self.planet, "trainer_brawler",0,1305.89,7,3087.58,0,0)
--	spawnMobile(self.planet, "trainer_brawler",0,1741,7,3117,0,0)
	spawnMobile(self.planet, "trainer_carbine",0,1196,7,3110,225,0)
