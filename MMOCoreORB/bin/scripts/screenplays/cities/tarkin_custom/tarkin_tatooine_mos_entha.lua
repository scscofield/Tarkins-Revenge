...
function TarkinTatooineMosEnthaScreenPlay:spawnSceneObjects()
	...
	spawnSceneObject(self.planet, "object/tangible/crafting/station/public_space_station.iff", 1130.59, 7, 3033.31, 0, math.rad(80) )
	spawnSceneObject(self.planet, "object/tangible/crafting/station/public_clothing_station.iff", 1141.02, 7, 2999.06, 0, math.rad(180) )
	spawnSceneObject(self.planet, "object/tangible/crafting/station/public_weapon_station.iff", 1140.96, 7, 2993.84, 0, math.rad(90) )
	spawnSceneObject(self.planet, "object/tangible/crafting/station/public_food_station.iff", 1133.76, 7, 2986.03, 0, math.rad(156) )
	spawnSceneObject(self.planet, "object/tangible/crafting/station/public_structure_station.iff", 1128.23, 7, 3039.11, 0, math.rad(50) )
	--Lower Floor
...
--	self:setMoodString(pNpc, "npc_standing_drinking")
	--center Tavern AA
	pNpc = spawnMobile(self.planet, "scientist",60,1465.75,7,3175.76,270,0)
--	self:setMoodString(pNpc, "sad")
...
--	spawnMobile(self.planet, "surgical_droid_21b",60,-25.52,0.26,-3.48,142.122,1153586)
	spawnMobile(self.planet, "trainer_combatmedic",0,1376.91,7,3239.14,15,0)
...
--	self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "businessman",60,1131.28,7,3030.04,42.5733,0)
...
--	self:setMoodString(pNpc, "calm")
	spawnMobile(self.planet, "criminal",300,1135,7,3028,0,0)
...
--	spawnMobile(self.planet, "eg6_power_droid",60,1332.45,7.90682,3237.09,8.18614,0)
	spawnMobile(self.planet, "informant_npc_lvl_1",0,1126.79,7,3040.59,30,0)
	spawnMobile(self.planet, "informant_npc_lvl_1",0,1711.13,7,3066.78,0,0)
...
--	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "noble",60,1187,7,2942,360.011,0)
--	self:setMoodString(pNpc, "conversation")
...
--	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "scientist",60,1137.4,7,3027.22,0,0)
--	self:setMoodString(pNpc, "conversation")
...
--	self:setMoodString(pNpc, "conversation")
	...
	spawnMobile(self.planet, "trainer_brawler",0,1132.53,7,2982.77,55,0)
--	spawnMobile(self.planet, "trainer_brawler",0,1741,7,3117,0,0)
	spawnMobile(self.planet, "trainer_carbine",0,1142,7,3056,61,0)
	spawnMobile(self.planet, "trainer_commando",0,1564,7,3413,0,0)
	spawnMobile(self.planet, "trainer_creaturehandler",0,1399.32,7,3240.28,8,0)
	spawnMobile(self.planet, "trainer_doctor",0,1380,7,3240,290,0)
	--spawnMobile(self.planet, "trainer_entertainer",0,1287,7,3163,85,0)
	spawnMobile(self.planet, "trainer_marksman",0,1138,7,2987,90,0)
	spawnMobile(self.planet, "trainer_medic",0,1130,7,2978,90,0)
	spawnMobile(self.planet, "trainer_merchant",0,1126,7,2973,39,0)
	--spawnMobile(self.planet, "trainer_musician",0,1481,7,3267,0,0)
	spawnMobile(self.planet, "trainer_ranger",0,1381.27,7,3469.2,180,0)
	spawnMobile(self.planet, "trainer_scout",0,1139,7,3024,90,0)
