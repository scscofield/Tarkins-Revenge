...
function RoriBlackSunOutpostBunkerScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "black_sun_smuggler_poi_3", 900, -74.0476, -50.0, 38.5287, 84, 3566259)
	...
	spawnMobile("rori", "black_sun_minion_poi_3", 900, -99.8546, -50.0, 91.5676, -152, 3566259)
