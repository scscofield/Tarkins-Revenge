object_draft_schematic_weapon_pistol_intimidator = object_draft_schematic_weapon_shared_pistol_intimidator:new {
   ...
   resourceTypes = {"steel", "aluminum", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_pistol_intimidator_barrel.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
