object_draft_schematic_furniture_tarkin_custom_aurebesh_forn = object_draft_schematic_furniture_tarkin_custom_shared_aurebesh_forn:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_furniture_tarkin_custom_aurebesh_forn, "object/draft_schematic/furniture/tarkin_custom/aurebesh_forn.iff")
